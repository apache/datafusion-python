```python exec="1" session="introduction"
import os
import pathlib
...
```python exec="1" source="material-block" result="text" session="introduction"
...
![Rendered table showing Pokemon DataFrame](../images/jupyter_lab_df_view.png)
