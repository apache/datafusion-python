...
class SessionContext:
    def __init__(
        ...
        runtime: Optional[RuntimeEnvBuilder] = None,
    ) -> None: ...
    def enable_url_table(self) -> SessionContext: ...
    def register_object_store(
        self, schema: str, storage: Any, host: Optional[str] = None
    ): ...
    ...
    def sql_with_options(
        self, query: str, options: Optional[SQLOptions] = None
    ) -> DataFrame: ...
    ...
    def from_arrow(
        self,
        data: ArrowStreamExportable | pa.RecordBatchReader,
        name: Optional[str] = None,
    ) -> DataFrame: ...
    def from_pandas(
    ...
    def from_polars(
        self, data: pl.DataFrame, name: Optional[str] = None
    ) -> DataFrame: ...
...
class DataFrame:
    ...
    def join(
        self, right: DataFrame, how: str, left_on: List[str], right_on: List[str]
    ) -> DataFrame: ...
    def join_on(
        self, right: DataFrame, on_exprs: List[Expr], how: str
    ) -> DataFrame: ...
