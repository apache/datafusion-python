...
scalar_function!(
    left,
    Left,
    r"Returns first n characters in the string, or when n is negative, returns all but last \|n\| characters."
);
...
scalar_function!(
    right,
    Right,
    r"Returns last n characters in the string, or when n is negative, returns all but first \|n\| characters."
);
